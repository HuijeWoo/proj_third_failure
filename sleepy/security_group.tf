...
####
resource "aws_security_group_rule" "ingr_22_for_web_with_public" {
    type              = "ingress"
    to_port           = 22
    protocol          = "tcp"
    from_port         = 22
...
resource "aws_security_group_rule" "ingr_from_public" {
    type              = "ingress"
    to_port           = 8080
    protocol          = "tcp"
    from_port         = 8080
...
####
resource "aws_security_group_rule" "ingr_22_for_was_with_public" {
    type              = "ingress"
    to_port           = 22
    protocol          = "tcp"
    from_port         = 22
